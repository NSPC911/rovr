...
- **buttons**: compacts the action buttons and path input to one line instead of three
  <InlineSVG src="/rovr/screenshots/compact_buttons.svg" alt="compact buttons enabled" />
- **panels**: makes the footer panels smaller to give more room for the file list
  <InlineSVG src="/rovr/screenshots/compact_panels.svg" alt="compact panels enabled" />
