...
![main page](/rovr/screenshots/main.svg)
...
![select mode](/rovr/screenshots/select-mode.svg)
...
- **copy**: `y` or `ctrl+c`
![copy button](/rovr/screenshots/copy-button.svg)
- **cut**: `x` or `ctrl+x`
![cut button](/rovr/screenshots/cut-button.svg)
- **paste**: `p` or `ctrl+v`
![paste button](/rovr/screenshots/paste-button.svg)
- **delete**: `d` or `delete` key
![delete button](/rovr/screenshots/delete-button.svg)
- **rename**: `r` or `f2`
![rename button](/rovr/screenshots/rename-button.svg)
- **create new entries**: `ctrl+n` or `o`
![new entry button](/rovr/screenshots/new-entry-button.svg)
- **compress to archive**: `E` (uppercase E)
![compress button](/rovr/screenshots/compress-button.svg)
- **extract archive**: `ctrl+e`
![extract button](/rovr/screenshots/extract-button.svg)
- **copy path**: `Y` (uppercase Y)
![copy button](/rovr/screenshots/copy-path-button.svg)
...
![search bar](/rovr/screenshots/search-files.svg)
- **pin current folder**: `P` (uppercase P)
<br/><sub>no images again lol</sub>
- **command palette**: `ctrl+p`
![command palette](/rovr/screenshots/command-palette.svg)
...
- **toggle sidebar**: `S`
![sidebarless](/rovr/screenshots/sidebarless.svg)
- **toggle preview**: `I`
![previewless](/rovr/screenshots/previewless.svg)
- **toggle footer**
![footerless](/rovr/screenshots/footerless.svg)
- **toggle header**
![headerless](/rovr/screenshots/headerless.svg)
<br/><sub>looks very similar to another file explorer...</sub>
- **focus sidebar**: `s`
- **focus file list**: `esc`
- **focus preview**: `i`
- **focus metadata**: `m`
...
rovr is designed similarly to ghostty where it should work with minimal configuration, but has a quite comprehensive customisability options.
common changes would be these

```toml
[interface]
# hide hidden files (toggleable with `.`)
show_hidden = true
