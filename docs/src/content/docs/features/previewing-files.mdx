...
for pdf files, rovr makes use of [poppler](https://poppler.freedesktop.org) via [pdf2image](https://pypi.org/project/pdf2image). you can also scroll through the pdf with your mouse (scrollbars are unavailable for now) or use your keyboard to navigate it.
