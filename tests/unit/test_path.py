...
class TestIsHiddenFile:
    ...
    def test_dotfile_hidden_on_unix(self, temp_dir):
    ...
    def test_file_in_hidden_directory(self, temp_dir):
    ...
    def test_windows_hidden_attribute(self, temp_dir):
    ...
    @pytest.mark.skipif(os.name != 'nt', reason="Windows-only test")
    def test_windows_regular_file_not_hidden(self, temp_dir):
...
class TestPathEdgeCases:
    ...
    def test_normalise_with_drive_letter(self):
        """Windows drive letters handled correctly."""
        result = normalise("C:\\")
        assert "C" in result.upper()

    def test_normalise_unc_path(self):
    ...
    def test_compress_very_long_path(self):
