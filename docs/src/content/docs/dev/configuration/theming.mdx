...
rovr includes some extra classes that can be used to narrow down the elements.
...
| Class | Description                                                | Example                     |
| ----- | ---------------------------------------------------------- | --------------------------- |
| error | applied when an error occurred while in the process        | `ProcessBarContainer.error` |
| done  | applied when the process is done, regardless of the result | `ProcessBarContainer.done`  |

| Component Classes  | Description                                                        | Example                                     |
| ------------------ | ------------------------------------------------------------------ | ------------------------------------------- |
| bar--bar           | The default bar, used when the process is working                  | `ProcessBarContainer > .bar--bar`           |
| bar--indeterminate | Used when the process is still calculating and has not started yet | `ProcessBarContainer > .bar--indeterminate` |
| bar--complete      | Used when the process is complete                                  | `ProcessBarContainer > .bar--complete`      |
