...
- **images**: the image itself, using proper protocols (refer to [image-previews](/rovr/dev/features/image-previews/#supported-terminals))
...
- [user interface guide](/rovr/dev/guides/user-interface) - detailed interface explanation
- [file operations guide](/rovr/dev/guides/file-operations) - comprehensive operations reference
- [keybindings reference](/rovr/dev/reference/keybindings) - complete keyboard shortcuts
- [configuration guide](/rovr/dev/guides/configuration) - customize rovr to your needs
- [tips and tricks](/rovr/dev/guides/tips-and-tricks) - efficiency tips and power user features
