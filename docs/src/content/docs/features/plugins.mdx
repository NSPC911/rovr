...
`rovr` supports several plugins to improve its functionality. you can enable and configure them in your `config.toml` file.
...
allows you to use [fd](https://github.com/sharkdp/fd) to search recursively in the current directory
