...
themes are `tcss` files in `src/rovr/assets/themes/<name>.tcss`, made of variable declarations
...
for more information, please refer to [theming](/rovr/dev/configuration/theming)
...
{show what actually happened after doing the steps. preferably, paste the exception if the app had crashed.}
