...
for more details on the user interface, see the [user interface guide](/guides/user-interface).

for a full list of actions and their keybindings, refer to the [file operations guide](/guides/file-operations) and the [keybindings reference](/reference/keybindings).
